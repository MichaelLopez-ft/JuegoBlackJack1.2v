...
public class JuegoDeCartas {
    ...
    public JuegoDeCartas() {
        ...
        // Pedir el número de rondas
        pedirNumeroDeRondas();
    }

    private void pedirNumeroDeRondas() {
        Scanner scanner = new Scanner(System.in);
        System.out.print("Ingrese el número de rondas que desea jugar: ");
        numeroDeRondas = scanner.nextInt();
    }
    ...
    public void jugarRonda() {
        System.out.println("Mostrando las cartas de los jugadores:");
    ...
    public void jugar() {
        repartirCartas(10); // Reparte 10 cartas a cada jugador
